...
abstract class BaseQuestion extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Smirik\\QuizBundle\\Model\\QuestionPeer';
    ...
    /**
     * The value for the num_answers field.
     * @var        int
     */
    ...
    /**
     * Get the [num_answers] column value.
     *
     * @return int
     */
    ...
    public function setFile($v)
    {
        ...
        if ($this->file !== $v) {
            $this->file = $v;
            $this->modifiedColumns[] = QuestionPeer::FILE;
        }
    ...
    /**
     * Set the value of [num_answers] column.
     *
     * @param int $v new value
     * @return Question The current object (for fluent API support)
     */
    public function setNumAnswers($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->num_answers !== $v) {
            $this->num_answers = $v;
            $this->modifiedColumns[] = QuestionPeer::NUM_ANSWERS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->num_answers = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
            ...
            return $startcol + 7; // 7 = QuestionPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(QuestionPeer::TEXT)) {
            $modifiedColumns[':p' . $index++]  = '`TEXT`';
        }
        if ($this->isColumnModified(QuestionPeer::TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`TYPE`';
        }
        if ($this->isColumnModified(QuestionPeer::FILE)) {
            $modifiedColumns[':p' . $index++]  = '`FILE`';
        }
        if ($this->isColumnModified(QuestionPeer::NUM_ANSWERS)) {
            $modifiedColumns[':p' . $index++]  = '`NUM_ANSWERS`';
        }
        if ($this->isColumnModified(QuestionPeer::CREATED_AT)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`FILE`':
                        ...
                        break;
                    case '`NUM_ANSWERS`':
                        $stmt->bindValue($identifier, $this->num_answers, PDO::PARAM_INT);
                        break;
                    case '`CREATED_AT`':
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setNumAnswers($arr[$keys[4]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(QuestionPeer::FILE)) $criteria->add(QuestionPeer::FILE, $this->file);
        if ($this->isColumnModified(QuestionPeer::NUM_ANSWERS)) $criteria->add(QuestionPeer::NUM_ANSWERS, $this->num_answers);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setNumAnswers($this->getNumAnswers());
    ...
    public function setQuizQuestions(PropelCollection $quizQuestions, PropelPDO $con = null)
    {
        ...
        foreach ($this->quizQuestionsScheduledForDeletion as $quizQuestionRemoved) {
            $quizQuestionRemoved->setQuestion(null);
        }
     ...
     * @return PropelObjectCollection|QuizQuestion[] List of QuizQuestion objects
     */
    public function getQuizQuestionsJoinQuiz($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = QuizQuestionQuery::create(null, $criteria);
    ...
    {
        $this->answersScheduledForDeletion = $this->getAnswers(new Criteria(), $con)->diff($answers);

        foreach ($this->answersScheduledForDeletion as $answerRemoved) {
    ...
    public function setUserQuestions(PropelCollection $userQuestions, PropelPDO $con = null)
    {
        ...
        foreach ($this->userQuestionsScheduledForDeletion as $userQuestionRemoved) {
            $userQuestionRemoved->setQuestion(null);
        }
