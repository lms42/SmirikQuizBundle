...
abstract class BaseQuizQuestion extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Smirik\\QuizBundle\\Model\\QuizQuestionPeer';
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = QuizQuestionPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = QuizQuestionQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(QuizQuestionPeer::QUESTION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`QUESTION_ID`';
        }
        if ($this->isColumnModified(QuizQuestionPeer::QUIZ_ID)) {
            $modifiedColumns[':p' . $index++]  = '`QUIZ_ID`';
        }

        $sql = sprintf(
            'INSERT INTO `quiz_questions` (%s) VALUES (%s)',
    ...
    {
        $pos = QuizQuestionPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['QuizQuestion'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['QuizQuestion'][serialize($this->getPrimaryKey())] = true;
        $keys = QuizQuestionPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildPkeyCriteria()
    {
        ...
        $criteria->add(QuizQuestionPeer::QUIZ_ID, $this->quiz_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getQuestionId()) && (null === $this->getQuizId());
    }
    ...
    public function getQuestion(PropelPDO $con = null)
    {
        if ($this->aQuestion === null && ($this->question_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aQuestion->addQuizQuestions($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(QuizQuestionPeer::DEFAULT_STRING_FORMAT);
    }
