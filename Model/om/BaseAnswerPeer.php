...
use Smirik\QuizBundle\Model\map\AnswerTableMap;
...
abstract class BaseAnswerPeer
{
    ...
    const OM_CLASS = 'Smirik\\QuizBundle\\Model\\Answer';
    ...
    const IS_RIGHT = 'answers.IS_RIGHT';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'QuestionId', 'Title', 'File', 'IsRight', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'questionId', 'title', 'file', 'isRight', ),
        BasePeer::TYPE_COLNAME => array (AnswerPeer::ID, AnswerPeer::QUESTION_ID, AnswerPeer::TITLE, AnswerPeer::FILE, AnswerPeer::IS_RIGHT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'QUESTION_ID', 'TITLE', 'FILE', 'IS_RIGHT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'question_id', 'title', 'file', 'is_right', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'QuestionId' => 1, 'Title' => 2, 'File' => 3, 'IsRight' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'questionId' => 1, 'title' => 2, 'file' => 3, 'isRight' => 4, ),
        BasePeer::TYPE_COLNAME => array (AnswerPeer::ID => 0, AnswerPeer::QUESTION_ID => 1, AnswerPeer::TITLE => 2, AnswerPeer::FILE => 3, AnswerPeer::IS_RIGHT => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'QUESTION_ID' => 1, 'TITLE' => 2, 'FILE' => 3, 'IS_RIGHT' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'question_id' => 1, 'title' => 2, 'file' => 3, 'is_right' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AnswerPeer::TITLE);
            $criteria->addSelectColumn(AnswerPeer::FILE);
            $criteria->addSelectColumn(AnswerPeer::IS_RIGHT);
        } else {
    ...
    /**
     * Method to invalidate the instance pool of all tables related to answers
    ...
    public static function doCountJoinQuestion(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(AnswerPeer::QUESTION_ID, QuestionPeer::ID, $join_behavior);
    ...
    /**
     * Deletes all rows from the answers table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += AnswerPeer::doOnDeleteCascade(new Criteria(AnswerPeer::DATABASE_NAME), $con);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += AnswerPeer::doOnDeleteCascade($c, $con);
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        $objects = AnswerPeer::doSelect($criteria, $con);
        foreach ($objects as $obj) {
            ...
            $criteria->add(UserQuestionPeer::ANSWER_ID, $obj->getId());
