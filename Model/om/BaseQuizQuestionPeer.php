...
use Smirik\QuizBundle\Model\map\QuizQuestionTableMap;
...
abstract class BaseQuizQuestionPeer
{
    ...
    const OM_CLASS = 'Smirik\\QuizBundle\\Model\\QuizQuestion';
     ...
     * e.g. QuizQuestionPeer::$fieldNames[QuizQuestionPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('QuestionId', 'QuizId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('questionId', 'quizId', ),
        BasePeer::TYPE_COLNAME => array (QuizQuestionPeer::QUESTION_ID, QuizQuestionPeer::QUIZ_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('QUESTION_ID', 'QUIZ_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('question_id', 'quiz_id', ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. QuizQuestionPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('QuestionId' => 0, 'QuizId' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('questionId' => 0, 'quizId' => 1, ),
        BasePeer::TYPE_COLNAME => array (QuizQuestionPeer::QUESTION_ID => 0, QuizQuestionPeer::QUIZ_ID => 1, ),
        BasePeer::TYPE_RAW_COLNAME => array ('QUESTION_ID' => 0, 'QUIZ_ID' => 1, ),
        BasePeer::TYPE_FIELDNAME => array ('question_id' => 0, 'quiz_id' => 1, ),
        BasePeer::TYPE_NUM => array (0, 1, )
    );
    ...
    {
        $toNames = QuizQuestionPeer::getFieldNames($toType);
        $key = isset(QuizQuestionPeer::$fieldKeys[$fromType][$name]) ? QuizQuestionPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(QuizQuestionPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, QuizQuestionPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return QuizQuestionPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(QuizQuestionPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(QuizQuestionPeer::DATABASE_NAME);
     ...
     *
     * @param      QuizQuestion $obj A QuizQuestion object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if ($key === null) {
                $key = serialize(array((string) $obj->getQuestionId(), (string) $obj->getQuizId()));
            } // if key === null
            QuizQuestionPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof QuizQuestion) {
                $key = serialize(array((string) $value->getQuestionId(), (string) $value->getQuizId()));
            ...
            unset(QuizQuestionPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(QuizQuestionPeer::$instances[$key])) {
                return QuizQuestionPeer::$instances[$key];
            }
        }
    ...
    {
        QuizQuestionPeer::$instances = array();
    }
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        $cls = QuizQuestionPeer::getOMClass();
     ...
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     * @return array (QuizQuestion object, last column rank)
     */
    public static function populateObject($row, $startcol = 0)
    {
        $key = QuizQuestionPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = QuizQuestionPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + QuizQuestionPeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = QuizQuestionPeer::OM_CLASS;
            $obj = new $cls();
    ...
    public static function doCountJoinQuestion(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(QuizQuestionPeer::QUESTION_ID, QuestionPeer::ID, $join_behavior);
    ...
    public static function doCountJoinQuiz(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(QuizQuestionPeer::QUIZ_ID, QuizPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of QuizQuestion objects pre-filled with their Question objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinQuestion(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        QuizQuestionPeer::addSelectColumns($criteria);
        $startcol = QuizQuestionPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (QuizQuestion) to $obj2 (Question)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        QuizQuestionPeer::addSelectColumns($criteria);
        $startcol2 = QuizQuestionPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (QuizQuestion) to the collection in $obj2 (Question)
                $obj2->addQuizQuestion($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (QuizQuestion) to the collection in $obj3 (Quiz)
                $obj3->addQuizQuestion($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of QuizQuestion objects pre-filled with all related objects except Question.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of QuizQuestion objects pre-filled with all related objects except Quiz.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    {
        return Propel::getDatabaseMap(QuizQuestionPeer::DATABASE_NAME)->getTable(QuizQuestionPeer::TABLE_NAME);
    }
    ...
    {
        return QuizQuestionPeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a QuizQuestion or Criteria object.
     *
    ...
    /**
     * Performs an UPDATE on the database, given a QuizQuestion or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(QuizQuestionPeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(QuizQuestionPeer::QUESTION_ID);
            $value = $criteria->remove(QuizQuestionPeer::QUESTION_ID);
            if ($value) {
                $selectCriteria->add(QuizQuestionPeer::QUESTION_ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(QuizQuestionPeer::TABLE_NAME);
            }

            $comparison = $criteria->getComparison(QuizQuestionPeer::QUIZ_ID);
            $value = $criteria->remove(QuizQuestionPeer::QUIZ_ID);
            if ($value) {
                $selectCriteria->add(QuizQuestionPeer::QUIZ_ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(QuizQuestionPeer::TABLE_NAME);
            }
    ...
    /**
     * Deletes all rows from the quiz_questions table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(QuizQuestionPeer::TABLE_NAME, $con, QuizQuestionPeer::DATABASE_NAME);
    ...
    /**
     * Performs a DELETE on the database, given a QuizQuestion or Criteria object OR a primary key value.
     *
     ...
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(QuizQuestionPeer::QUESTION_ID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(QuizQuestionPeer::QUIZ_ID, $value[1]));
                $criteria->addOr($criterion);
                // we can invalidate the cache for this single PK
                QuizQuestionPeer::removeInstanceFromPool($value);
            }
        }
     ...
     * @return   QuizQuestion
     */
    public static function retrieveByPK($question_id, $quiz_id, PropelPDO $con = null) {
        $_instancePoolKey = serialize(array((string) $question_id, (string) $quiz_id));
         if (null !== ($obj = QuizQuestionPeer::getInstanceFromPool($_instancePoolKey))) {
             return $obj;
        }
        ...
        $criteria = new Criteria(QuizQuestionPeer::DATABASE_NAME);
        $criteria->add(QuizQuestionPeer::QUESTION_ID, $question_id);
        $criteria->add(QuizQuestionPeer::QUIZ_ID, $quiz_id);
